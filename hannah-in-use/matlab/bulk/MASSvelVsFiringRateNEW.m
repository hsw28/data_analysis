function f = MASSvelVsFiringRateNEW(spikestructure, posstructure, timestructure, binsize)
...
%  %use clusterimport.m and posimport.m and timeimport.m to create spike and position structures
  ...
  output = {'cluster name'; '# spikes'; 'slope'; 'r2 value'; 'p value'};
  ...
  subplot(ceil(columns), ceil(rows), k)
    ...
    newdata = {name; length(spikesizes); slope; rsquared; pval};
