                 ...
                 int nrhs, const mxArray *prhs[])
{
     ...
     * for a set of test responses. A kronecker delta kernel is used for all dimensions
     * and the data is assumed to be normalized by the desired kernel width.
     * Note that a radial-symmetric delta kernel is used, rather than a multiplicative kernel.
     *
     * syntax:
     * out = kde_decode_kronecker( stimulus, stimulus_grid, response, test_response[, offset[, distance[, timestamp, bins]]] );
     *
     * arguments:
