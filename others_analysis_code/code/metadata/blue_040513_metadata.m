function m = blue_040513_metadata()

% Notes: see notes.txt

m.today = '040513';
m.basePath = ['~/Data/blue/',m.today];
m.loadTimewin = [ 400, 6400 ];
m.loadTimewin = [5000,6400]; % Cut down on the enormous file size
...
% Time blacklists
m.ctxBlacklist = {[2094,2097.5];[2888,2892];[4052,4055];[4395,4398];...
                  [4464,4466];[4890,4893];[4894.5,4898];[4899,4901];...
                  [5380,5386];[5439,5444];[5464,5472]};
m.rscThreshold = 10;
m.ctxThreshold = 10;
