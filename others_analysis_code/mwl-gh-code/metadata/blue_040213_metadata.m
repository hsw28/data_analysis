function m = blue_040213_metadata()

% Notes: see notes.txt

m.today = '040213';
m.basePath = ['~/Data/blue/',m.today];
m.loadTimewin = [ 200, 1883 ];
...
m.ad_tts = {'15','16','17','18','19','20','23','24','25','26','27','29','29','30'}; % NOTE we're missing tt12 and tt14 today for some reason
